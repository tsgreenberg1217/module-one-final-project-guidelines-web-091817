...
anon_19 = Player.create(username: "Anonymous", total_score: 500)
anon_20 = Player.create(username: "Anonymous", total_score: 400)
anon_21 = Player.create(username: "Anonymous", total_score: 300)
anon_22 = Player.create(username: "Anonymous", total_score: 100)
anon_23 = Player.create(username: "Anonymous", total_score: 100)
anon_24 = Player.create(username: "Anonymous", total_score: 100)
anon_25 = Player.create(username: "Anonymous", total_score: 80)
...
game_10 = Game.create(players: [anon_19], mode: "Survival", difficulty: "Hard")
game_11 = Game.create(players: [anon_20], mode: "Survival", difficulty: "Hard")
game_12 = Game.create(players: [anon_21], mode: "Survival", difficulty: "Hard")
game_13 = Game.create(players: [anon_22], mode: "Survival", difficulty: "Hard")
game_14 = Game.create(players: [anon_23], mode: "Survival", difficulty: "Hard")
game_15 = Game.create(players: [anon_24], mode: "Survival", difficulty: "Hard")
game_16 = Game.create(players: [anon_25], mode: "Survival", difficulty: "Hard")
